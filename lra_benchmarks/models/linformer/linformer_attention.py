...
class LinformerAttention(nn.Module):
    ...
    def __call__(
        ...
        query, key, value = (
            dense(dtype=dtype, name="query")(inputs_q),
            dense(dtype=dtype, name="key")(inputs_kv),
            dense(dtype=dtype, name="value")(inputs_kv),
        )
        ...
        low_rank_kernel = self.param(
            "lr_kernel", kernel_init, (max_len, low_rank_features)
        )
...
class LinformerSelfAttention(nn.Module):
    ...
    @nn.compact
    def __call__(self, inputs_q, num_heads, *args, **kwargs):
        return LinformerAttention(inputs_q, None, num_heads, *args, **kwargs)
